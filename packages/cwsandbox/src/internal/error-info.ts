...
export const CWSANDBOX_FSS_NOT_FOUND = "CWSANDBOX_FSS_NOT_FOUND";

// File-system snapshot reasons
export const CWSANDBOX_FSS_NOT_SUPPORTED = "CWSANDBOX_FSS_NOT_SUPPORTED";
export const CWSANDBOX_FSS_NOT_READY = "CWSANDBOX_FSS_NOT_READY";
export const CWSANDBOX_FSS_BACKEND_THROTTLED = "CWSANDBOX_FSS_BACKEND_THROTTLED";
export const CWSANDBOX_FSS_INFLIGHT_LIMIT = "CWSANDBOX_FSS_INFLIGHT_LIMIT";
export const CWSANDBOX_FSS_BUCKET_PROVISIONING = "CWSANDBOX_FSS_BUCKET_PROVISIONING";
export const CWSANDBOX_FSS_SIZE_EXCEEDED = "CWSANDBOX_FSS_SIZE_EXCEEDED";
export const CWSANDBOX_FSS_QUOTA_EXCEEDED = "CWSANDBOX_FSS_QUOTA_EXCEEDED";
export const CWSANDBOX_FSS_BUCKET_MISMATCH = "CWSANDBOX_FSS_BUCKET_MISMATCH";
...
export const CWSANDBOX_RUNNER_SHARD_RETIRING = "CWSANDBOX_RUNNER_SHARD_RETIRING";
